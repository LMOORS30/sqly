...
/// or [`#[sqly(delete)]`](derive@Table#delete)
/// instead.
pub trait Delete {
    /// The type representing the table which this query will operate on.
    /// 
    /// When generated with [`#[derive(Delete)]`](derive@Delete) this type is set by the [`#[sqly(table = Ident)]`](derive@Table#table) attribute.
    /// 
