...
If not specified this defaults to the type of the chosen foreign field, otherwise an error will be raised.
...
This function is also used to provide the default value for [`#[sqly(skip)]`](#skip).
